...
import com.example.masharie.StudentNotificationsAdapter
import com.example.masharie.databinding.FragmentStudentNotificationsBinding
...
class StudentNotificationsFragment : Fragment() {
    ...
    // انشيلايز للادبتر
    private val myAdapter = StudentNotificationsAdapter()
    override fun onCreateView(
        ...
        val notiRecycler = binding.studentNotificationsRecyclerView
        // تفعيل الادبتر
