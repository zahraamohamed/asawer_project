...
import com.example.masharie.Fragments.TeacherAccountFragmentDirections

class TeacherProjectsAdapter  : RecyclerView.Adapter<TeacherProjectsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.projectCard.setOnClickListener {
            val action = TeacherAccountFragmentDirections.actionTeacherAccountFragmentToStudentSingleProjectFragment(projectsList[position])
